...
export default () => {
  return (
    <button  className="text-xl mt-2 rounded-full p-2 border-2 w-fit border-gray-500 flex items-center text-gray-500 hover:text-orange-500 hover:border-orange-500 hover:scale-105">
